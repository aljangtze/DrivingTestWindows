...
{
    public partial class FormEasyErrorManager : Form
    {
        private FormModelAdd _formModelAdd = null;
        public FormEasyErrorManager()
        {
            InitializeComponent();
        }
        ...
        {
            labelTittle.Text = "强化练习易错题管理--对强化练习信息进行维护，进行套题的增加、删除、修改";
        }
        ...
        private void AddItem(int id, string tittle, bool status, int type, int count)
        {
            ...
            txtBox5.ToolTipText = "此易错题下面的题目数";
        ...
        public bool SendBack(ModelChapter model, bool Replace)
        {
            if (true == Replace)
            {
                ...
                path = ModelManager._PathEasyError;
