...
namespace Beinet.cn.DrivingTest
{
    ...
    */
    public partial class Form1 : Form
    {
        ...
        //[DllImport("SkyVoice.dll", CharSet=CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        //extern static bool ttsInitial(string path);
...
//extern "C" _declspec(dllexport) void test();
        ...
        //private void test()
        //{
        //    if(true == ttsInitial("SkyVoice.ini"))
        ...
        void ShowNext()
        {
            ...
            if (!isRestore)
            {
                ...
                if (!string.IsNullOrEmpty(pic))
                {
                    ...
                    {
                        this.axShockwaveFlash1.Movie = @"D:\Projects\C#\Beinet.cn.DrivingTest-master\bin\Debug\jk\" + question.id + ".swf";
        ...
        {
            this.axShockwaveFlash1.Movie = @"D:\Projects\C#\Beinet.cn.DrivingTest-master\bin\Debug\jk\1541.swf";
            this.axShockwaveFlash1.Rewind();
            this.axShockwaveFlash1.Play();
        }
        ...
        {
            GetQuestion questiong = new GetQuestion();
            questiong.Show();
        }
