...
namespace DrivingTest
{
    ...
    public partial class GetQuestion : Form
    {
        ...
        internal static Encoding GB2312 = Encoding.GetEncoding("utf-8");
        /// <summary>
        /// 考题里的分隔符，必须与抓取程序一致
        /// </summary>
        ...
        /// </summary>
        internal const int QUESTION_NUM = 9714;// 2011年C1考题总数是725;    
        /// <summary>
        /// 访问网络用的Cookie容器
        /// </summary>
        ...
        private const string _starturl = "http://wz.jxedt.com/test/abcd/sxlx.asp?type=c";
        private const string _quesurl =
            "http://wz.jxedt.com/test/abcd/ajax.asp?r=0.555714223572155&index={0}";
        ...
        public GetQuestion()
        {
            ...
            for (int i = 1; i <= Form1.QUESTION_NUM; i++)
            {
                ...
                if (!string.IsNullOrEmpty(question.imageurl))//question.imageurl
                {
                    ...
                    //视屏
                    //http://img.58cdn.com.cn/jxedt/radio/kaoshi/40001.swf

                    string bigUrl = "http://ww3.sinaimg.cn/mw600/" + question.sinaimg;
                    if (question.imageurl.IndexOf(".swf") != -1)
                        bigUrl = question.imageurl;
        ...
        string DownImgs(string imeurl, int id)
        {
            ...
            {
                DownloadFile(imeurl, imgfile, Cookies, id);
            }
            ret += imgname + ",";
            return ret;
        }
        ...
        void DownloadFile(string downloadUrl, string savePath, CookieContainer cookieContainer, int id)
        {
